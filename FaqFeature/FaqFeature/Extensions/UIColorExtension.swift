...
extension UIColor{
    static let snowBlue: UIColor = UIColor(red: 0.06, green: 0.08, blue: 0.60, alpha: 1.00)
    ...
    static let snowTextGray: UIColor = UIColor(red: 0.69, green: 0.69, blue: 0.72, alpha: 1.00)
